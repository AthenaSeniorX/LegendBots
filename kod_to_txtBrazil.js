...
async function addCodeToVIPCollection(code) {
    const collectionName = 'BrazilPack5';
    const docId = 'Kvuawy2gPOwa7EetGm7C'; // Doğru doküman ID'si
...
(async () => {
    ...
    const giftCodeUrl = 'https://novoevento78-lobr.oasgames.com/userGiftCode'; // Kodların alındığı URL
    const desiredTypes = ['sign8'];
