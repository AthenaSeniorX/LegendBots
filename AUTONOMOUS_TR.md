...
4. **BOT 4 / MANAGER** — heartbeat, PID, claim, istenen worker durumu ve havuz zincirini denetler. Kısa yeniden başlatma pencerelerinde yanlış alarm üretmez. Bağımsız Windows supervisor, manager dahil istenen bir workerın hostu tamamen ölürse çakışma korumalı biçimde geri getirir; beş dakika heartbeat üretmeyen süreci yeniler. Sağlıklı durumda gereksiz çıktı üretmez.
